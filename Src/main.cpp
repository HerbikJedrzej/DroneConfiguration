...
GlobalStruct globalStruct = {40.0};
...
int main(void)
{
  ...
  led.addLED(LedsList::optionProcess, OutputList::LED_Y2, false);
  led.addLED(LedsList::initFailure, OutputList::LED_R1, false);
  ...
  if(getHWID() != 14){
    Drivers::gpio.pin(OutputList::LED_R1, false);
  ...
  while(true){
      ...
      TIM3->CCR2 = enginesPower[2];
      TIM3->CCR1 = enginesPower[3];
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, writeProtect_Pin|LED5_Pin|LED3_Pin|LED2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|LED6_Pin|LED4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RADIO_CSN_Pin RADIO_CE_Pin */
  ...
  /*Configure GPIO pin : MPU_IRQ_Pin */
  GPIO_InitStruct.Pin = MPU_IRQ_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(MPU_IRQ_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : writeProtect_Pin LED5_Pin LED3_Pin LED2_Pin */
  GPIO_InitStruct.Pin = writeProtect_Pin|LED5_Pin|LED3_Pin|LED2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : LED1_Pin LED6_Pin LED4_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|LED6_Pin|LED4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
